...
<?php elseif ( $user->roles[0] == 'ms_cm_2' && has_term('ms-cm-2','restriction') ):?>
<header class="container page-header">
    <h1>Contenu restreint</h1>
    <p>Le formateur n'a pas encore autorisé l'accès à ce cours pour le moment.</p>
</header>
<?php elseif ( $user->roles[0] == 'imep' && has_term('imep','restriction') ):?>
<header class="container page-header">
    <h1>Contenu restreint</h1>
    <p>Le formateur n'a pas encore autorisé l'accès à ce cours pour le moment.</p>
</header>
...
<article id="post-<?php the_ID(); ?>" <?php post_class('container'); ?>>
    <div class="row">
        ...
        <div class="col-sm-4 galerie">
            ...
            <p class="mdp">Mot de passe :<br /><strong><?php the_field('mot_de_passe_correction') ?></strong></p>
            <?php endif; ?>
            <!-- Affichage du mot de passe si la case est coché et que le rôle est "MS CM 1" -->
            <?php if($user->roles[0] == 'ms_cm_1' && get_field('correction_ms_cm_1') == true ): ?>
            <a href="<?php the_field('correction') ?>" class="correction">Télécharger la correction</a>
            <p class="mdp">Mot de passe :<br /><strong><?php the_field('mot_de_passe_correction') ?></strong></p>
            <?php endif; ?>
            <!-- Affichage du mot de passe si la case est coché et que le rôle est "MS CM 2" -->
            <?php if($user->roles[0] == 'ms_cm_2' && get_field('correction_ms_cm_2') == true ): ?>
            <a href="<?php the_field('correction') ?>" class="correction">Télécharger la correction</a>
            <p class="mdp">Mot de passe :<br /><strong><?php the_field('mot_de_passe_correction') ?></strong></p>
            <?php endif; ?>
            <!-- Affichage du mot de passe si la case est coché et que le rôle est "MS CM 1" -->
            <?php if($user->roles[0] == 'imep' && get_field('correction_imep') == true ): ?>
            <a href="<?php the_field('correction') ?>" class="correction">Télécharger la correction</a>
            <p class="mdp">Mot de passe :<br /><strong><?php the_field('mot_de_passe_correction') ?></strong></p>
            <?php endif; ?>
            <?php endif; ?>
